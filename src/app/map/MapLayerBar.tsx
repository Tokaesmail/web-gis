...
import { SAT_LAYERS, SatKey } from "./mapTypes_proxy";
...
export default function MapLayerBar({
  ...
  return (
    <div className="absolute bottom-2 left-2 right-2 sm:bottom-4 sm:left-1/2 sm:right-auto sm:w-max sm:-translate-x-1/2 z-1000 flex items-center gap-2 pointer-events-auto overflow-x-auto sm:overflow-visible app-scroll pb-1 sm:pb-0">
      {/* Satellite selector */}
      <div className="flex shrink-0 items-center bg-[#0a1628]/95 backdrop-blur-md border border-white/10 rounded-full px-1 py-1 shadow-lg gap-0.5">
      ...
      {/* Opacity Slider */}
      <div className="hidden md:flex items-center gap-3 bg-[#0a1628]/95 backdrop-blur-md border border-white/10 rounded-full px-4 py-1.5 shadow-lg min-w-[140px]">
      ...
      {/* Active indicator */}
      <div className="hidden lg:flex items-center gap-1.5 bg-[#0a1628]/95 backdrop-blur-md border border-white/8 rounded-full px-2.5 py-1.5 shadow-lg">
