...
import { DrawTool, SatKey, IdxKey } from "./mapTypes";
    ...
    <div className={`flex flex-col w-full h-screen bg-[#040d1a] overflow-hidden ${isRTL ? "font-arabic" : ""}`}>
      ...
      <div className="relative flex-1 overflow-hidden">
        <LeafletMap
          ...
          flyToRef={flyToRef}
          clearRef={clearRef}
          onSatChange={useCallback((handler) => { changeSatRef.current = handler; }, [])}
          onIdxChange={useCallback((handler) => { changeIdxRef.current = handler; }, [])}
        />
        ...
        {captureUrl && (
          <div className="absolute bottom-20 left-16 z-[900] pointer-events-auto animate-fadeUp">
