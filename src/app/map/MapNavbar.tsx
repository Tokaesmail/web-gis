...
export default function MapNavbar({
  ...
  return (
<nav className="h-12 flex items-center justify-between gap-2 px-3 sm:px-4 bg-[#040d1a] border-b border-white/[0.07] shrink-0 z-1100 relative">      <Link href="/" className="flex min-w-0 items-center gap-2 no-underline">
