...
export default async function ChangePasswordPage() {
  ...
  const res= await fetch(`${process.env.NEXT_PUBLIC_API_URL}/auth/change-password`, {
    ...
    body: JSON.stringify({ currentPassword: "current_password", newPassword: "new_secure_password" }),
  }
);


  console.log("Profile page ping:", res.status);
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white/2 border border-white/6 rounded-xl p-4 space-y-2">
        <p className="text-[0.68rem] text-slate-500 uppercase tracking-wider">Password Requirements</p>
        {[
          ...
          <div key={tip} className="flex items-center gap-2">
            <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="#22d3ee" strokeWidth="2.5"><polyline points="20 6 9 17 4 12"/></svg>
      ...
      <p className="text-center text-[0.72rem] text-slate-600">
        ...
        <Link href="/auth/sessions" className="text-cyan-400 hover:text-cyan-300">
